  ...
  <div>
    ...
    <div class="result">
        ...
        <div class="ad-display" border="1">
            <fieldset>
            <%for (resultIndex = 0; resultIndex < ((ArrayList<Item>)session.getAttribute("amazon_items")).size(); resultIndex++){ %>
            <%
                String title = ((ArrayList<Item>)session.getAttribute("amazon_items")).get(resultIndex).getTitle();
                String img = ((ArrayList<Item>)session.getAttribute("amazon_items")).get(resultIndex).getImg();
                String price = ((ArrayList<Item>)session.getAttribute("amazon_items")).get(resultIndex).getPrice();
                String url = ((ArrayList<Item>)session.getAttribute("amazon_items")).get(resultIndex).getUrl();
            %>
