...
public class WebClient {
	...
	public static void main(String[] args) throws Exception {
		//String download = new WebClient().download("http://crawltest.cis.upenn.edu/international/corriere.xml");
		//System.out.println(download);
		
		//String download = new WebClient().download("http://tutorials.jenkov.com/java-io/inputstream.html");
		//System.out.println(download);
		
		String download = new WebClient().download("http://finance.yahoo.com/");
		System.out.println(download);
	}
